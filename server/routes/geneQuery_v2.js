...
app.get('/api/cancer_driver_list', (request, response, next) => {
  ...
  let sql = 'SELECT pmid, cancertype, gene, element, mutatedsamplesize, cohortsize, evidencetype, evidencemethod FROM "noncoding_cancer_driver_Jan_22_2020" where 1 = 1';
