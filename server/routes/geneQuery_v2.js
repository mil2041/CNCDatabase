...
app.get('/api/cancer_driver_list', (request, response, next) => {
  ...
  let sql = 'SELECT pmid, cancertype, cancer_full_name, gene, cosmic, element, mutatedsamplesize, cohortsize, evidencetype, evidencemethod FROM "noncoding_cancer_driver_Feb_20_2020" where 1 = 1';
